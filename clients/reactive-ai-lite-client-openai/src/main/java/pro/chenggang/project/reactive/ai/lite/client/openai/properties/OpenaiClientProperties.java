...
public class OpenaiClientProperties implements InitializingBean {
    ...
    private void checkChatProviderProperties(ChatProvider chatProvider) {
        ...
        Assert.hasLength(chatProvider.getChatCompletionEndpoint(), "The chatCompletionEndpoint of OpenAI chat API is required.");
    ...
    public static class ChatProvider {
        ...
        /**
         * The chatCompletionEndpoint for the chat completions API. Defaults to "/v1/chat/completions".
         */
        private String chatCompletionEndpoint = "/v1/chat/completions";
        /**
