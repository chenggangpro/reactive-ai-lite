...
/**
 * Ollama LLM provider information implementation.
 * <p>
 * This class extends {@link AbstractLlmProviderInfo} to provide specific configuration
 * and metadata for the Ollama language model provider. It encapsulates the provider's
 * name and other relevant information needed for Ollama integration.
 * </p>
 *
 * @author Gang Cheng
 * @version 0.1.0
...
public class OllamaLlmProviderInfo extends AbstractLlmProviderInfo {
    ...
    /**
     * The default name identifier for the Ollama provider.
     */
    public static final String DEFAULT_NAME = "Ollama";

    /**
     * The name of the Ollama provider.
    ...
    /**
     * Returns the name of the Ollama LLM provider.
     * <p>
