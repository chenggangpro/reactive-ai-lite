...
class DefaultMediaMessageTest {
    ...
    void testBuilderAndGetters() {
        ...
        DefaultMediaMessage message = DefaultMediaMessage.builder()
                .role(role)
                .content(content)
                .name(name)
        ...
        assertThat(message.getActualType()).isEqualTo(DefaultMediaMessage.class);
    }
}
